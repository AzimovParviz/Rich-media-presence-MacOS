...
main: 
	clang -o main.o main.c -L./$(LIB_DIR) -ldiscord_game_sdk -lpthread -rpath ./$(LIB_DIR)

x86_64: 
	clang -o main.o main.c -L./$(LIB_DIR) -ldiscord_game_sdk -lpthread -rpath $(LIB_DIR) -target x86_64-apple-macosx10.15

arm64: 
	clang -o main.o main.c -L./$(LIB_DIR) -ldiscord_game_sdk -lpthread -rpath $(LIB_DIR) -target arm64-apple-macosx11
